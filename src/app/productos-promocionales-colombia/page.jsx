...
export const metadata = {
  ...
  keywords: [
    ...
    'regalos corporativos colombia',
    'artículos publicitarios colombia',
    'merchandising empresarial colombia',
    'productos promocionales bogota',
    'productos promocionales medellin',
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Encuentra artículos promocionales en las principales ciudades de Colombia con atención personalizada y entrega directa.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ¿Por qué elegir KS Promocionales en Colombia?
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Envíos a Todo Colombia</h3>
              <p className="text-gray-600">
                Cobertura nacional con entrega en Bogotá, Medellín, Cali, Barranquilla, Cartagena y cualquier ciudad.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="bg-primary/10 text-primary w-14 h-14 rounded-xl flex items-center justify-center mb-6">
      ...
      <section className="py-16 lg:py-24 bg-gray-900 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/593999814838?text=Hola%2C%20me%20interesa%20cotizar%20productos%20promocionales%20para%20Colombia"
              target="_blank"
